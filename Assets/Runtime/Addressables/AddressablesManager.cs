...
namespace Runtime.Addressables
{
    ...
    public class AddressablesManager : MonoInstaller
    {
        ...
        public override void Start()
        {
            ...
            UnityEngine.AddressableAssets.Addressables.InitializeAsync().Completed += AddressablesManager_Completed;
            base.Start();
        }
        ...
        public void unloadMech()
        {
            if (myMech.skin != null)
            {
                UnityEngine.AddressableAssets.Addressables.Release(myMech.skin);
                myMech.skin = null;
            }
